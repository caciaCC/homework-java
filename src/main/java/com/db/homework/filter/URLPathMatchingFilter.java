package com.db.homework.filter;

import com.db.homework.service.UserService;
import com.db.homework.utils.SpringContextUtils;
...
public class URLPathMatchingFilter extends PathMatchingFilter {
    @Autowired
    UserService adminPermissionService;
...
//        return true; //111
        ...
        if (null==adminPermissionService) {
            adminPermissionService = SpringContextUtils.getContext().getBean(UserService.class);
        }
        ...
        // 需要的是可用的User
//           User user = adminPermissionService.getByName(username);
//           if(!user.getEnabled()) {
//               System.out.println("该用户需要启用");
//               return false;
//           }
//           Role role = adminPermissionService.
        // 需要的是可用的Role
